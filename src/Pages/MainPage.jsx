...
// import * as style from "../utils/style.css";
...
const MainPage = () => {
  return (
    <main className="md:grid grid-rows-2 md:grid-cols-12 md:h-screen">
      ...
      <main
        className={`xl:col-span-10 lg:col-span-9 md:col-span-9 bg-pageColor md:h-screen row-span-1 order-1 md:order-2 overflow-scroll`}
      >
        <Outlet />
      </main>
    </main>
